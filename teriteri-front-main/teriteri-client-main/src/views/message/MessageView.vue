            ...
            <div class="message-layout">
                    ...
                    <div class="side-bar">
                        ...
                        <ul class="side-list">
                            ...
                            >
                                <div class="text">
                                    {{ item.name }}
                                    <span class="notify notify-number" v-if="userStore.user?.uid && messageStore.msgUnread[index] > 0">
                                        {{ messageStore.msgUnread[index] <= 99 ? messageStore.msgUnread[index] : '99+' }}
                                    </span>
                                </div>
                            </li>
                        </ul>
                        ...
                        <div class="setting">
                            <div class="item" :class="{'active': routerIndex === 5}" @click="router.push('/message/config')">
                ...
                <div class="space-right">
                    <div class="space-right-top">
                        <div class="title">
                            <span>{{ routerList[routerIndex] ? routerList[routerIndex].name : "消息设置" }}</span>
                        </div>
                    </div>
...
const routerIndex = computed(() => {
    let i = routerList.findIndex(item => route.path.startsWith(item.path));
    if (i === -1) {
        return 5;
    } else {
        return i;
